...
// Sample products array (aap apna data yahan daal sakte hain)
const products = [
  {
    id: 1,
  ...
  {
    id: 25,
    name: "Printed Sharara Suit",
    category: "ethnic",
    price: 699,
    rating: 4.8,
    image:
      "https://i.pinimg.com/736x/67/e0/85/67e085c01dfdd3e34d96acc1516d408f.jpg",
    description: "Beautiful sharara suit for festive occasions.",
  },
  {
    id: 23,
    ...
    rating: 4.3,
    image:
      "https://i.pinimg.com/736x/6a/ac/b5/6aacb591680283de50a82cefccbfb7d4.jpg",
    description: "Simple flats for daily use and college wear.",
  },
  {
    id: 55,
    name: "Clutch Bag with Embroidery",
    category: "accessories",
    price: 699,
    rating: 4.5,
    image:
      "https://i.pinimg.com/736x/b1/8e/e6/b18ee655ce1fc9fe6cc3386133513503.jpg",
    description: "Stylish embroidered clutch for festive occasions.",
  },
  {
    id: 29,
    name: "Streetstyle Hoodie",
    category: "western",
    price: 399,
    rating: 4.7,
    image:
      "https://i.pinimg.com/736x/eb/5c/55/eb5c55627c25de0d2940096fba7cc85f.jpg",
    description: "Unisex hoodie with modern prints and oversized fit.",
  },
  {
    id: 10,
